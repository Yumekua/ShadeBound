...
public class DomeController : MonoBehaviour
{
    ...
    public const float WorldCameraMinPitch = 0.0f;
    public const float WorldCameraMaxPitch = 150.0f;
	...
	public const float DefCrescentFadeRadius    =  0.6f;
    public const float DefCrescentFadeOffset    = -0.9f;

	public const int FOVIncrement = 5;
	public const float RotationIncrement = 5.0f;
	public const float FadeIntensityIncrement = 0.1f;
	public const float FadeRadiusIncrement = 0.0f;
	...
	private void ResetToDefaults()
	{
		...
		cubeMapType = CubeMapType.Cube8192;
		antiAliasingType = AntiAliasingType.SSAA_4X;
		QualitySettings.vSyncCount = 1;
	...
	private void SaveSettingsToFile(string filename)
	{
		using (StreamWriter stream = new StreamWriter(filename))
		{
			...
			stream.WriteLine(string.Format("crescentFadeRadius = {0}", 0.6f));
